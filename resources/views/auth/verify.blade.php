    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <div class="bg-info rounded shadow-sm p-4 text-left">
                    ...
                    <a href="{{ route('verification.resend') }}" class="btn btn-secondary btn-block">{{ translate('Click here to request another') }}</a>
                    @if (session('resent'))
