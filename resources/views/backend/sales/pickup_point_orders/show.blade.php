    			...
    			<div class="col text-center text-md-left">
                    <address>
                        <strong class="text-main">{{ json_decode($order->shipping_address)->name }}</strong><br>
                         ...
                         {{ json_decode($order->shipping_address)->address }}, {{ isset(json_decode($order->shipping_address)->ccity) ? json_decode($order->shipping_address)->ccity : '' }}, {{ json_decode($order->shipping_address)->country }}
                    </address>
                    ...
                    <table class="invoice-details table table-bordered aiz-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    {{ single_price($order->orderDetails->sum('paid')) }}
                                </td>
                            </tr>
                            <tr>
                                <td class="text-main text-bold">
                                ...
                                <td class="text-right">
                                    {{ single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax') - $order->orderDetails->sum('paid')) }}
                                </td>
                            </tr>
                            <tr>
                                <td class="text-main text-bold">
    		...
    		<div class="clearfix float-right">
    			<table class="table">
                    ...
                    <tr>
        				...
        				<td class="text-bold h5">
        					{{ single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax') + $order->orderDetails->sum('shipping_cost') - $order->orderDetails->sum('paid')) }}
        				</td>
        			</tr>
        			</tbody>
    			</table>
