...
<div class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
            ...
            <div class="d-none d-md-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-transparent" href="{{ route('home')}}" target="_blank" title="{{ translate('Visit Store') }}">
                            <i class="las la-desktop"></i> <span>{{ translate('Visit Store') }}</span>
                        </a>
                    </div>
                </div>
                            ...
                            <span class="btn btn-icon p-1">
                                <span class=" position-relative d-inline-block">
                                    ...
                                    @if($orders > 0 || $sellers > 0)
                                        <span class="badge badge-dot badge-circle badge-primary position-absolute absolute-top-left"></span>
                                    @endif
                                </span>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-animated dropdown-menu-lg py-0">
        ...
        <div class="d-none d-lg-flex justify-content-around align-items-center align-items-stretch">
            <div class="aiz-topbar-item">
                <div class="d-flex align-items-center">
                    <div class="clock" onload="showTime()"><span>{{ date('d-m-Y') }} {{ date('l') }} </span><span id="MyClockDisplay"></span></div>
                </div>
            </div>
        </div>
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            ...
            <div class="aiz-topbar-item ml-2">
                <div class="d-flex align-items-center">
                    <a class="btn btn-transparent" href="{{ route('system_server')}}" title="{{ translate('Server Status') }}">
                        <i class="las la-signal"></i> <span>{{ translate('Server Status') }}</span>
                    </a>
                </div>
            </div>
