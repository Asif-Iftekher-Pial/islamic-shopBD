    ...
    <div class="row">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group mb-0">
                            <button type="submit" class="btn btn-sm btn-secondary">{{translate('Save')}}</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <!--    <div class="card">-->
        <!--        <div class="card-header ">-->
        <!--            <h5 class="mb-0 h6">{{translate('ShurjoPay Credential')}}</h5>-->
        <!--        </div>-->
        <!--        <div class="card-body">-->
        <!--            <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">-->
        <!--                @csrf-->
        <!--                <input type="hidden" name="payment_method" value="shurjopay">-->
        <!--                <div class="form-group row">-->
        <!--                    <input type="hidden" name="types[]" value="SHURJOPAY_MERCHANT_USERNAME">-->
        <!--                    <div class="col-md-4">-->
        <!--                        <label class="col-from-label">{{translate('MERCHANT USERNAME')}}</label>-->
        <!--                    </div>-->
        <!--                    <div class="col-md-8">-->
        <!--                        <input type="text" class="form-control" name="SHURJOPAY_MERCHANT_USERNAME" value="{{  env('SHURJOPAY_MERCHANT_USERNAME') }}" placeholder="{{translate('MERCHANT USERNAME')}}" required>-->
        <!--                    </div>-->
        <!--                </div>-->
        <!--                <div class="form-group row">-->
        <!--                    <input type="hidden" name="types[]" value="SHURJOPAY_MERCHANT_PASSWORD">-->
        <!--                    <div class="col-md-4">-->
        <!--                        <label class="col-from-label">{{translate('MERCHANT PASSWORD')}}</label>-->
        <!--                    </div>-->
        <!--                    <div class="col-md-8">-->
        <!--                        <input type="text" class="form-control" name="SHURJOPAY_MERCHANT_PASSWORD" value="{{  env('SHURJOPAY_MERCHANT_PASSWORD') }}" placeholder="{{translate('MERCHANT PASSWORD')}}" required>-->
        <!--                    </div>-->
        <!--                </div>-->
        <!--                <div class="form-group row">-->
        <!--                    <input type="hidden" name="types[]" value="SHURJOPAY_MERCHANT_KEY_PREFIX">-->
        <!--                    <div class="col-md-4">-->
        <!--                        <label class="col-from-label">{{translate('MERCHANT KEY PREFIX')}}</label>-->
        <!--                    </div>-->
        <!--                    <div class="col-md-8">-->
        <!--                        <input type="text" class="form-control" name="SHURJOPAY_MERCHANT_KEY_PREFIX" value="{{  env('SHURJOPAY_MERCHANT_KEY_PREFIX') }}" placeholder="{{translate('MERCHANT KEY PREFIX')}}" required>-->
        <!--                    </div>-->
        <!--                </div>-->
        <!--                <div class="form-group row">-->
        <!--                    <input type="hidden" name="types[]" value="SHURJOPAY_SERVER_URL">-->
        <!--                    <div class="col-md-4">-->
        <!--                        <label class="col-from-label">{{translate('SERVER URL')}}</label>-->
        <!--                    </div>-->
        <!--                    <div class="col-md-8">-->
        <!--                        <input type="text" class="form-control" name="SHURJOPAY_SERVER_URL" value="{{  env('SHURJOPAY_SERVER_URL') }}" placeholder="{{translate('SERVER URL')}}" required>-->
        <!--                    </div>-->
        <!--                </div>-->
        <!--                <div class="form-group mb-0">-->
        <!--                    <button type="submit" class="btn btn-sm btn-secondary">{{translate('Save')}}</button>-->
