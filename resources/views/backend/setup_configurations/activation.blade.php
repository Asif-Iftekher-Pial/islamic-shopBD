...
<h4 class="text-center text-muted">{{translate('Module Activation')}}</h4>
<div class="row">
    ...
    <div class="col-lg-3 col-md-3 col-sm-4">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6 text-center">{{translate('Partial Payment Activation')}}</h3>
            </div>
            <div class="card-body text-center">
                <label class="aiz-switch aiz-switch-success mb-0">
                    <input type="checkbox" onchange="updateSettings(this, 'partial_system')" <?php if(\App\BusinessSetting::where('type', 'partial_system')->first()->value == 1) echo "checked";?>>
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <div class="alert" style="color: #c22;background-color: #d7d7d7;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
  ...
  <!--      <div class="card">-->
  <!--          <div class="card-header">-->
  <!--              <h3 class="mb-0 h6 text-center">{{translate('ShurjoPay Activation')}}</h3>-->
  <!--          </div>-->
  <!--          <div class="card-body text-center">-->
  <!--              <div class="clearfix">-->
  <!--                  <img class="float-left" src="{{ static_asset('assets/img/cards/shurjoPay.png') }}" height="30">-->
  <!--                  <label class="aiz-switch aiz-switch-success mb-0 float-right">-->
  <!--                      <input type="checkbox" onchange="updateSettings(this, 'shurjopay')" <?php if(\App\BusinessSetting::where('type', 'shurjopay')->first()->value == 1) echo "checked";?>>-->
  <!--                      <span class="slider round"></span>-->
  <!--                  </label>-->
  <!--              </div>-->
  <!--              <div class="alert" style="color: #c22;background-color: #d7d7d7;border-color: #b8daff;margin-bottom:0;margin-top:10px;">-->
  <!--                  You need to configure ShurjoPay correctly to enable this feature. <a href="{{ route('payment_method.index') }}">Configure Now</a>-->
  <!--              </div>-->
  <!--          </div>-->
  <!--      </div>-->
  <!--  </div> -->
    ...
    <div class="col-lg-3 col-md-3 col-sm-4">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6 text-center">{{translate('Breadcums Activation')}}</h3>
            </div>
            <div class="card-body text-center">
                <label class="aiz-switch aiz-switch-success mb-0">
                    <input type="checkbox" onchange="updateSettings(this, 'breadcums')" <?php if(\App\BusinessSetting::where('type', 'breadcums')->first()->value == 1) echo "checked";?>>
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
