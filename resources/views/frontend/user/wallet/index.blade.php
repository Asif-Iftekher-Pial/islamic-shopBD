...
@section('panel_content')
    ...
    <div class="row gutters-10">
      <div class="col-md-4 mx-auto mb-3" >
          <div class="bg-grad text-white rounded-lg overflow-hidden">
      ...
      <div class="col-md-4 mx-auto mb-3" >
        <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition" onclick="show_wallet_modal()">
            <span class="size-60px rounded-circle mx-auto bg-matt d-flex align-items-center justify-content-center mb-3">
                              ...
                              <div class="mb-3">
                                  <select class="form-control selectpicker" data-minimum-results-for-search="Infinity" name="payment_option" data-live-search="true">
                                      ...
                                      @if (\App\BusinessSetting::where('type', 'shurjopay')->first()->value == 1)
                                          <option value="shurjopay">{{ translate('ShurjoPay')}}</option>
                                      @endif
