...
@section('panel_content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{ translate('Shipping Area') }}</h5>
        </div>
        <div class="card-body">
            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PATCH">
                ...
                <div class="form-box-content p-3">
                    <div class="row mb-3">
                        <div class="col-12">
                            <input type="hidden" name="shippings[]" value="shop_shippings">
                            <select name="shop_shippings[]" class="form-control aiz-selectpicker" multiple data-actions-box="true" data-max-options="10" data-live-search="true" data-selected={{ $shop->shop_shippings }} required>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{ translate('Shop Policy') }}</h5>
        </div>
        <div class="card-body">
            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PATCH">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <textarea
                                ...
                                name="policy"
                                required
                            >@php echo $shop->policy ; @endphp</textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group mb-0 text-right">
