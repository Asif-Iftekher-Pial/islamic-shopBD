            ...
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-2 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-5px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-60px h-md-80px" height="80">
                        @else
                ...
                <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white border border-danger rounded-25">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark d-md-none">
                ...
                <div class="navbar-brand">
                    <ul class="list-inline mb-0 pl-0">
                        <li class="list-inline-item mr-0">
                            <a href="{{ route('wishlists.index') }}" class="text-white opacity-100 fs-16 px-3 py-2 d-inline-block fw-600 hov-opacity-80">
                                {{translate('WISHLIST')}}
                            </a>
                        </li>
                        <li class="list-inline-item mr-0">
                            <a href="{{ route('compare') }}" class="text-white opacity-100 fs-16 px-3 py-2 d-inline-block fw-600 hov-opacity-80">
                                {{translate('COMPARE')}}
                            </a>
                        </li>
                    </ul>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a href="{{ json_decode( get_setting('main_header_menu_links'), true)[$key] }}" class="nav-link text-white opacity-100 fs-16 px-3 py-2 d-inline-block fw-600 hov-opacity-80">
                            {{ translate($value) }}
                        </a>
                    </li>
                    @endforeach
            ...
            <div class="container d-none d-md-block">
                <div class="d-flex justify-content-between">
                    <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-left">
                          ...
                          @if(Route::currentRouteName() != 'home')
                            <div class="d-none d-xl-block align-self-stretch category-menu-icon-box ml-auto mr-0">
                                <div class="h-100 d-flex align-items-center text-white" id="category-menu-icon">
                                    <div class="dropdown-toggle bg-transparent h-40px pl-2 c-pointer">
                        ...
                        @foreach (json_decode( get_setting('main_header_menu_labels'), true) as $key => $value)
                        <li class="list-inline-item mr-0">
                            <a href="{{ json_decode( get_setting('main_header_menu_links'), true)[$key] }}" class="text-white opacity-100 fs-16 px-3 py-2 d-inline-block fw-600 hov-opacity-80">
                                {{ translate($value) }}
                            </a>
                        </li>
                        @endforeach
