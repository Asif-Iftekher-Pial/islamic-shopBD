    ...
    <div class="position-relative logo-bar-area z-1">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div
                    class="flex-grow-1 front-header-search d-flex align-items-center bg-white border border-danger rounded-25">
                ...
                <div class="d-none d-lg-block ml-3 mr-0">
                    <div class="" id="phone">
                        <a href="tel:+88{{ get_setting('contact_phone') }}"
                            ...
                            <span class="flex-grow-1 ml-1">
                                ...
                                <span
                                    class="nav-box-text font-weight-bold d-none d-xl-block opacity-70">{{ get_setting('contact_phone') }}</span>
                            </span>
                        </a>
                    </div>
                </div>
