...
class ShopController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $seller->commission = BusinessSetting::where('type', 'vendor_commission')->first()->value;
        $seller->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        elseif($request->has('policy')){
            $shop->policy = $request->policy;
        }

        elseif($request->has('shop_shippings')){
            $shop->shop_shippings = $request->shop_shippings;
        }
