    ...
    public function index(Request $request, $pay_amount = null)
    {
            ...
            if(Session::has('payment_type')){
                ...
                if(Session::get('payment_type') == 'cart_payment'){
                    ...
                    $post_data = array();
                    // $post_data['total_amount'] = $request->payment_type && $request->payment_type == 'partial' ? $request->amount : $order->grand_total; # You cant not pay less than 10
    ...
    public function success(Request $request)
    {
        ...
        if(isset($request->value_c)){
            ...
            elseif ($request->value_c == 'partial') {
                ...
                return $partialController->partial_payment_done(json_decode($request->value_b), $payment, $amount, 'SSLCommerz');
            }
